...
//#define    motor1       7                     //Controle In2 do driver L298N
...
#define    encodPinA1   2                     // encoder A pin      //Conexão C1 do encoder
#define    encodPinB1   4                     // encoder B pin      //Conexão C2 do encoder
#define    encoder_Z    3                     //Conexão Z do encoder
...
static long countAnt = 0;                                                   // last count
 ...
 speed_act = ((count - countAnt)*(60*(1000/LOOPTIME)))/(1024);          // 16 pulses X 29 gear ratio = 464 counts per output shaft rev
